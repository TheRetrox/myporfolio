...
const projectData = {
    ...
    gravity: {
        ...
        icon: "fas fa-meteor",
        description: "Welcome to Gravitas — A Semi-Realistic Gravity Simulation Gravitas is a semi-realistic Earth-based gravity simulator that models the gravitational forces between celestial bodies using Newton’s law of universal gravitation.",
